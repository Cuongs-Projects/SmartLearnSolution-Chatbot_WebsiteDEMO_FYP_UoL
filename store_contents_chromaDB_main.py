...
COLLECTION_NAME = "smartlearn_pf30drpp"
EMBEDDING_MODEL_NAME = 'all-MiniLM-L6-v2'

base_dir = "SML/PF30DRPP" #directory to access the transcribed contents eg SML/PADBRC
transcribed_contents = "transcribed_contents"

COLLECTION_NAME_TO_DELETE = "smartlearn_pf30drpp" # The specific collection you want to reset
...
class SCCDB_SML():
    ...
    def db_batch_prep(all_chunks_data):
        ...
        section_dict = {}
        if COLLECTION_NAME == "smartlearn_paadbrc":
            section_dict = {"S0":"Preparation","S1":"Starting_Exercise","S2":"Module_1"}
        elif COLLECTION_NAME == "smartlearn_pf30drpp":
            section_dict = {"S0":"Preparation","S1":"Select_Journal_and_Edit_Manuscript","S2":"The_Steps_of_The_Submission_Process"}
