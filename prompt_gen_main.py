...
class PG_SML():
    ...
    @staticmethod
    def embed_question_and_retrieves(user_question,embedding_model,collection,prompt_type,module_name,num_results_to_fetch = 100,full_response = None):
        try:
        ...
        if retrieved_documents:
            ...
            if prompt_type == "init":
                ...
                Right now, you will be answering the student's question based on the content from module "{module_name}", which is provided as CONTEXT FOR ANSWERING.
                ...
                You are a teacher for the website "SmartLearnSolution.com".
                Right now, you will be answering the students based on the content from module "{module_name}", which is provided as CONTEXT FOR ANSWERING.
                Please answer the student question as if you are confident about this knowledge field.
                Your personality is: friendly, helpful, encouraging, and patient. But not too much, be human-like.
    ...
    def generate_answer(chosen_model,prompt_type,prompt_to_llm = None,full_response_past = None):
        ...
        #Thinking is removed for AI's clarity in generating next answer and token efficiency
